...
;; ── T6.2: precompiled KIR is the product artifact (catalog-wide) ─────
;; Compiler stays :test-only; every kotoba/*_core.kotoba must ship a matching
;; resources/murakumo/oracle/*.kir.edn that does not drift, and every catalog
;; entry must load. Individual module drift tests remain as focused gates.
