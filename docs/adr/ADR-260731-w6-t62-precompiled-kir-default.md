...
4. **CI gate**: catalog-wide drift
   ...
   to the shipped resource (plus completeness + prod-deps assertions).
...
- Other product repos (com-cloudflare already has a similar pattern) are not
  re-audited here; T6.2 for murakumo is the reference.
